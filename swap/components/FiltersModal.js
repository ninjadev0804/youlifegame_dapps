      ...
      <div className="max-w-2xl w-full h-screen bg-[#F2F3F5] opacity-100 shrink-0 pt-10 md:pt-20 px-10 overflow-y-auto">
        ...
        <form action='#'>
          <div className='divide-y'>
            ...
            {/* USD range */}
            <div>
              <div className='flex justify-between mt-3 cursor-pointer' onClick={() => {onChevronHandler(0)}}>
            ...
            <div className='mt-8 cursor-pointer'>
              <div className='flex justify-between mt-3' onClick={() => {onChevronHandler(1)}}>
            ...
            {/* Transfer Sent */}
            <div className='mt-8 cursor-pointer' onClick={() => {onChevronHandler(2)}}>
