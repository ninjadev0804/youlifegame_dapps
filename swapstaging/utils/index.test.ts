...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')).toBe('0x5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')
      expect(isAddress('0x5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')).toBe('0x5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')).toBe('0x5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')
    })
    it('fails if too long', () => {
      expect(isAddress('5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')).toBe('0x5E3C...e841')
    })

    it('truncates middle characters even without prefix', () => {
      expect(shortenAddress('5E3Cae863a552DEf8e2a2749a5C65ecb21eCe841')).toBe('0x5E3C...e841')
    })
